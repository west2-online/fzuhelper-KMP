...
class PersonViewModel(
  ...
  private val _userData =
    CMutableStateFlow(MutableStateFlow<NetworkResult<UserData>>(NetworkResult.UnSend()))
  val userData = _userData.asStateFlow()
  private val _personIdentityData =
    CMutableStateFlow(MutableStateFlow<NetworkResult<PersonIdentityData>>(NetworkResult.UnSend()))
      ...
      viewModelScope.launch(Dispatchers.Default) {
        personRepository
          ...
          .actionWithLabel(
            ...
            collectAction = { label, data -> _userData.resetWithLog(label, data.toNetworkResult()) },
          )
      }
    }
  }
